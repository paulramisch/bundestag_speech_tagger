...
number_of_encoder_layers = 2  # number of nn.TransformerEncoderLayer in nn.TransformerEncoder
attention_head_size = 2  # number of heads in nn.MultiheadAttention
...
model = SpeechLabeler(
    ...
    embedding_size=embedding_size,
    d_hid=d_hid,
    number_of_encoder_layers=number_of_encoder_layers, # number of nn.TransformerEncoderLayer in nn.TransformerEncoder
...
for epoch in range(number_of_epochs):
    ...
    for batch in more_itertools.chunked(training_data, mini_batch_size):
        ...
        output = model.forward(batch_sentences)
